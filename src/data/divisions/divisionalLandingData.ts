...
export const divisionalLandingData: Record<DivisionId, DivisionLandingContent> = {
  generation: {
    ...
    roles: [
      ...
      { name: "Generation Project Teams", summary: "Deliver solar installations, storage, and plant upgrades.", actions: ["Submit requests", "Access specs", "Track progress", "Request build support"], cta: "Access Generation Project Workspace", route: "/stage2/document-studio/overview" },
