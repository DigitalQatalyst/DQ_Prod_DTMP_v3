...
export const divisionalLandingData: Record<DivisionId, DivisionLandingContent> = {
  ...
  transmission: {
    ...
    roles: [
      ...
      { name: "Transmission Project Teams", summary: "Execute Smart Grid and infrastructure transformation.", actions: ["Request specs", "Submit document requests", "Track progress", "Access build resources"], cta: "Access Project Workspace", route: "/stage2/document-studio/overview" },
  ...
  distribution: {
    ...
    roles: [
      ...
      { name: "Distribution Project Teams", summary: "Deliver metering, EV, and substation programmes.", actions: ["Submit requests", "Access specs", "Track progress", "Request EV build support"], cta: "Access Distribution Project Workspace", route: "/stage2/document-studio/overview" },
  ...
  "water-services": {
    ...
    roles: [
      ...
      { name: "Water Services Project Teams", summary: "Deliver desalination and monitoring programmes.", actions: ["Submit requests", "Access water specs", "Track progress", "Request build support"], cta: "Access Water Project Workspace", route: "/stage2/document-studio/overview" },
  ...
  "customer-services": {
    ...
    roles: [
      ...
      { name: "Customer Services Project Teams", summary: "Deliver AI deployments and integration programmes.", actions: ["Submit requests", "Access specs", "Track deployment progress", "Request build support"], cta: "Access Customer Project Workspace", route: "/stage2/document-studio/overview" },
  ...
  "digital-dewa-moro-hub": {
    ...
    roles: [
      ...
      { name: "AI & Platform Project Teams", summary: "Deliver AI deployments and infrastructure programmes.", actions: ["Submit AI requests", "Access specs", "Track VE delivery", "Request AI build support"], cta: "Access Digital DEWA Project Workspace", route: "/stage2/document-studio/overview" },
