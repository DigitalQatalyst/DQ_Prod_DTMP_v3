...
export const divisionalLandingData: Record<DivisionId, DivisionLandingContent> = {
  generation: {
    ...
    roles: [
      ...
      { name: "Generation Project Teams", summary: "Project managers and delivery teams executing generation transformation initiatives — new solar installations, storage systems, plant upgrades.", actions: ["Submit architecture requests", "Access generation solution specs", "Track initiative progress", "Request build support"], cta: "Access Generation Project Workspace", route: "/stage2/templates/overview" },
