...
interface MarketplaceHeaderProps {
  ...
  /** Optional content rendered in the right column of the header */
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4">
        <div className={`flex flex-col ${rightContent ? "lg:flex-row lg:items-center lg:gap-12" : ""}`}>
          ...
          {/* Right column — only rendered when rightContent is provided */}
          {rightContent && (
            <div className="mt-8 lg:mt-0 lg:w-72 shrink-0 flex items-center justify-center">
              {rightContent}
            </div>
          )}
        </div>
